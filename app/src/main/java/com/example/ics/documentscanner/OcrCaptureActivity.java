...
import com.example.ics.documentscanner.uiCamera.CameraSourcePreview;
import com.example.ics.documentscanner.uiCamera.GraphicOverlay;
import com.example.ics.documentscanner.uiCamera.CameraSource;
...
public class OcrCaptureActivity extends AppCompatActivity {
    ...
    private void createCameraSource(boolean autoFocus, boolean useFlash) {
        ...
        Bitmap textBitmap = BitmapFactory.decodeResource(getResources(), R.drawable.arrow);
        // A text recognizer is created to find text.  An associated processor instance
        // is set to receive the text recognition results and display graphics for each text block
        // on screen.
...
//        SparseArray<TextBlock> text = textRecognizer.detect(frame);
        Toast.makeText(OcrCaptureActivity.this, ""+textRecognizer.toString(), Toast.LENGTH_SHORT).show();
